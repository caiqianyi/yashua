...
public class MallProductCommentController {
    ...
    ResponseMessage info(@PathVariable("id") Long id){
		MallProductCommentEntity mallProductComment = mallProductCommentService.selectById(id);
        return ResponseMessage.ok().put("mallProductComment", mallProductComment);
    }
